...
db_sampler = dict(
    ...
    data_root='data/TJ4D/',
    info_path='data/TJ4D/TJ4Dv2_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=8,
    ...
    prepare=dict(
        filter_by_min_points=dict(Car=5, Cyclist=4, Pedestrian=3, Truck=6)),
    rate=1.0,
    sample_groups=dict(Car=10, Cyclist=10, Pedestrian=5, Truck=5))
default_hooks = dict(
...
randomness = dict(seed=104156657)
resume = False
test_cfg = dict()
test_dataloader = dict(
    ...
    dataset=[
        ...
        dict(ann_file='TJ4Dv2_infos_test.pkl'),
    ],
    drop_last=False,
    num_workers=1,
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=[
            ...
            dict(ann_file='TJ4Dv2_infos_train.pkl'),
        ],
        times=1,
        type='RepeatDataset'),
    num_workers=8,
...
val_dataloader = dict(
    ...
    dataset=[
        ...
        dict(ann_file='TJ4Dv2_infos_val.pkl'),
    ],
    drop_last=False,
    num_workers=8,
    persistent_workers=True,
...
val_evaluator = dict(
    ann_file='data/TJ4D/TJ4D_infos_val.pkl',
    backend_args=None,
    dataset=dict(ann_file='data/TJ4D/TJ4Dv2_infos_val.pkl'),
    metric='bbox',
    type='TJ4DMetric')
vis_backends = [
