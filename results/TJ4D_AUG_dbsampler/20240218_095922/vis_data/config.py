...
db_sampler = dict(
    ...
    rate=1.0,
    sample_groups=dict(Car=15, Cyclist=15, Pedestrian=15, Truck=5))
default_hooks = dict(
...
randomness = dict(seed=1663427688)
resume = False
test_cfg = dict()
            ...
            pipeline=[
                ...
                dict(
                    db_sampler=dict(
                        ...
                        rate=1.0,
                        sample_groups=dict(
                            Car=15, Cyclist=15, Pedestrian=15, Truck=5)),
                    type='ObjectSample',
...
work_dir = './results/TJ4D_AUG_dbsampler'
