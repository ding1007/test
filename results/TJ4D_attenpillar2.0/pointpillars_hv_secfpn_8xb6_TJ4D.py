...
model = dict(
    ...
    voxel_encoder=dict(
        ...
        type='AttentionPillarFeatureNet',
        voxel_size=[
            0.16,
            0.16,
            6,
...
param_scheduler = [
    ...
    dict(
        ...
        eta_min=3.0000000000000004e-07,
        type='CosineAnnealingLR'),
    dict(
        T_max=32.0,
        begin=0,
                    ...
                    db_sampler=dict(
                        ...
                        prepare=dict(
                            filter_by_min_points=dict(
                                Car=5, Cyclist=4, Pedestrian=3, Truck=6)),
                        rate=1.0,
                        sample_groups=dict(
                            Car=10, Cyclist=10, Pedestrian=5, Truck=5)),
                    type='ObjectSample',
...
work_dir = './results/TJ4D_attenpillar2.0'
