...
def get_image_path(idx,
                   ...
                   file_tail='.png',
                   use_prefix_id=False):
    return get_TJ4D_info_path(idx, prefix, info_type, file_tail, training,
...
def get_label_path(idx,
                   ...
                   info_type='label_2',
                   use_prefix_id=False):
    return get_TJ4D_info_path(idx, prefix, info_type, '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_velodyne_path(idx,
                      ...
                      exist_check=True,
                      use_prefix_id=False):
    return get_TJ4D_info_path(idx, prefix, 'velodyne', '.bin', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_calib_path(idx,
                   ...
                   exist_check=True,
                   use_prefix_id=False):
    return get_TJ4D_info_path(idx, prefix, 'calib', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_pose_path(idx,
                  ...
                  exist_check=True,
                  use_prefix_id=False):
    return get_TJ4D_info_path(idx, prefix, 'pose', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_timestamp_path(idx,
                       ...
                       exist_check=True,
                       use_prefix_id=False):
    return get_TJ4D_info_path(idx, prefix, 'timestamp', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_label_anno(label_path):
    ...
    num_objects = len([x[0] for x in content if x[0] != 'Other'])
...
def TJ4D_anno_to_label_file(annos, folder):
    folder = Path(folder)
    for anno in annos:
        ...
        for j in range(anno['bbox'].shape[0]):
            ...
            label_line = TJ4D_result_line(label_dict)
...
def TJ4D_result_line(result_dict, precision=4):
